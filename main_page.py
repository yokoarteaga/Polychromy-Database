    ...
    # --- modifying for mode "shaders"
        ...
        if st.session_state.selected_names:
            ...
            with downloadBlender_button_area:
                ...
                st.download_button( label='Download Blender', data=download_file_from_zenodo(name, key_ID=blend_ID, ext="zip"), file_name=f'{name}.zip', mime="application/octet-stream")
